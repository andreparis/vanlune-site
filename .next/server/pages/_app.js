...
const ThemeSettings = () => {
  ...
  Object(external_react_["useEffect"])(() => {
    ...
    Object(script["b" /* SlideUpDown */])('setting-title');
    return () => {
...
function MyApp({
  ...
  }), _app_jsx("title", null, "Vanlune - Best ecommerce for Gamers")), _app_jsx("div", null, _app_jsx(theme_setting_SettingProvider, null, _app_jsx(CompareContext["b" /* CompareContextProvider */], null, _app_jsx(CurrencyContext["c" /* CurrencyContextProvider */], null, _app_jsx(CartContext, null, _app_jsx(WishlistContext["d" /* WishlistContextProvider */], null, _app_jsx(Provider, null, _app_jsx(filter_FilterProvider, null, _app_jsx(Component, pageProps)))))), _app_jsx(theme_settings, null))), _app_jsx(external_react_toastify_["ToastContainer"], null), _app_jsx(Tap_Top, null))));
}
