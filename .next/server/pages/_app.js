...
// CONCATENATED MODULE: ./components/customizer/theme-settings.js
...
const ThemeSettings = () => {
  const context = Object(external_react_["useContext"])(theme_setting_SettingContext);
  const {
    0: themeLayout,
    1: setThemeLayout
  ...
  Object(external_react_["useEffect"])(() => {
    if (config["a" /* config */].layout_version && config["a" /* config */].layout_type) {
      document.body.className = `${config["a" /* config */].layout_version}  ${config["a" /* config */].layout_type}`;
    }
    ...
    Object(script["f" /* SlideUpDown */])('setting-title');
    return () => {
  ...
  return __jsx("div", null, __jsx("a", {
    ...
    toggle: toggle
  }, "Config"), __jsx(external_reactstrap_["ModalBody"], {
    className: "p-3"
  }, Object.keys(config["a" /* config */]).map((key, i) => __jsx("p", {
    key: i
  }, __jsx("span", null, key, ":"), __jsx("span", null, config["a" /* config */][key])))), __jsx(external_reactstrap_["ModalFooter"], null, __jsx("p", {
    className: "lh-cls"
  }, __jsx("b", null, "Note: "), "Copy upper config and paste it in ", __jsx("b", null, "\"/components/customizer/config.json\""), " "))), __jsx(external_react_toastify_["ToastContainer"], null));
};

/* harmony default export */ var theme_settings = (ThemeSettings);
...
var Tap_Top_jsx = external_react_default.a.createElement;
...
const TapTop = () => {
  ...
  return Tap_Top_jsx("div", {
    ...
    onClick: tapToTop
  }, Tap_Top_jsx("div", null, Tap_Top_jsx("i", {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Product2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return Product3; });
/* unused harmony export tools_product_4 */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return Product4; });
/* unused harmony export Product7 */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return Product5; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return Product6; });
/* unused harmony export Team4 */
/* unused harmony export Slider2 */
/* unused harmony export Slider3 */
/* unused harmony export Slider4 */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return svgservice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return svgoffer; });
